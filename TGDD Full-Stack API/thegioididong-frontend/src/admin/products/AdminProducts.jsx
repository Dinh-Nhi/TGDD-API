    ...
    constructor(props) {
      ...
      render() {
        ...
        <div id="layoutSidetop4">
          ...
          <a href="/admin-add-products">      <button style={{ height: "38px", marginTop: "40px", marginBottom: "20px", marginLeft: "3px" }} type="text" className="btn btn-success" onClick={this.addProduct}><i class="far fa-plus-square"></i> Thêm sản phẩm mới</button></a>
